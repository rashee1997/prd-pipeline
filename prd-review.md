---
description: "PRD Step 6/7 — Parallel code review: dispatches 6 specialist agents simultaneously (spec compliance, security, performance, TypeScript, code quality, test coverage). Each agent reads only its relevant files. Orchestrator merges findings, deduplicates, sorts by severity. Output: SEVERITY · CATEGORY · file:line / ✗ problem / ✓ fix."
